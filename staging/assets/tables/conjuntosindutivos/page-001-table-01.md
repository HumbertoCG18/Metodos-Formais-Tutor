...
| Devemos aceitar, inicialmente, a existência de alguns conceitos primitivos (noções que adotamos |
| sem definição) e que estabelecem a linguagem do estudo da Teoria dos Conjuntos. |
...
| O conjunto universo é o conjunto de todos os elementos do contexto sendo trabalhado e pode ser |
