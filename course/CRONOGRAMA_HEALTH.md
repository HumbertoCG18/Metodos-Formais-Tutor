...
- **T1 2026 1** — bloco `7a5e29db-f228-4e96-bd4b-272d5b74e2ae` (faixa baixa, conf 0.14, auto)
    ...
    - candidato `bloco-16` (score 1.89)
- **arvores** — bloco `5599d015-10e0-4f6e-ad17-c526b903dc09` (faixa media, conf 0.30, auto)
    - candidato `bloco-02` (score 1.54)
    - candidato `bloco-04` (score 1.11)
    - candidato `bloco-05` (score 1.02)
...
- **provas** — bloco `7a5e29db-f228-4e96-bd4b-272d5b74e2ae` (faixa media, conf 0.30, auto)
    ...
    - candidato `bloco-09` (score 1.97)
- **ExerciciosCorrecaoTerminacao** — bloco `c9f5f7cf-3477-4531-be7a-f7b68727009c` (faixa media, conf 0.40, auto)
    - candidato `bloco-11` (score 9.06)
...
- **ExerciciosDafny1** — bloco `95d7c9fb-d9e3-43cd-b1fb-5fcebddb49f0` (faixa baixa, conf 0.14, auto)
    ...
    - candidato `bloco-07` (score 3.50)
- **ExerciciosDafny2** — bloco `c9f5f7cf-3477-4531-be7a-f7b68727009c` (faixa baixa, conf 0.05, auto)
    - candidato `bloco-15` (score 4.94)
    - candidato `bloco-13` (score 4.14)
    - candidato `bloco-07` (score 3.50)
...
bloco-02, bloco-03, bloco-05, bloco-07, bloco-08, bloco-09, bloco-11, bloco-12, bloco-13, bloco-14, bloco-15, bloco-16, bloco-17, bloco-18, bloco-19, bloco-20, bloco-21

## Blocos mais ricos

- bloco-06: 3 material(is)
- bloco-01: 3 material(is)
- bloco-04: 2 material(is)
- bloco-10: 1 material(is)
- bloco-21: 0 material(is)
