...
Dadas as restrições do agente computacional, uma forma de computar a multiplicação entre dois números inteiros ( $m \times n, m \geq 0, n \geq 0$ ) é a que segue:
...
Uma especificação equacional de uma função  $f: A \rightarrow B$  é dada por equações da forma
...
$$mult(\langle m, n \rangle) = multacc(\langle m, n, 0 \rangle) \quad \langle 1 \rangle$$

onde

$multacc: \mathbb{N} \times \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$

$$multacc(\langle 0, y, a \rangle) = a \quad \langle 2 \rangle$$

$$multacc(\langle x + 1, y, a \rangle) = multacc(\langle x, y, a + y \rangle) \quad \langle 3 \rangle$$
...
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| $pot: \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$<br>$pot(\langle b, p \rangle) = 1, \text{ se } p = 0$<br>$pot(\langle b, p \rangle) = b \times pot(\langle b, p - 1 \rangle), \text{ se } p > 0$ | $pot: \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$<br>$pot(\langle b, p \rangle) = potAux(\langle b, p, 1 \rangle)$<br>onde<br>$potAux: \mathbb{N} \times \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$<br>$potAux(\langle b, p, a \rangle) = a, \text{ se } p = 0$<br>$potAux(\langle b, p, a \rangle) = potAux(\langle b, p - 1, a * b \rangle), \text{ se } p > 0$ |
...
$$mult(\langle m, n \rangle) = multacc(\langle m, n, 0 \rangle) \quad (1)$$

onde

$multacc: \mathbb{N} \times \mathbb{N} \times \mathbb{N} \rightarrow \mathbb{N}$

$$multacc(\langle 0, y, a \rangle) = a \quad (2)$$

$$multacc(\langle x + 1, y, a \rangle) = multacc(\langle x, y, a + y \rangle) \quad (3)$$
...
$$\begin{aligned}
 mult(5,3) &= multacc(5,3,0) \quad (1, [m \rightarrow 5, n \rightarrow 3]) \\
 &= multacc(4,3,3) \quad (3, [x \rightarrow 5, y \rightarrow 3, a \rightarrow 0]) \\
 &= multacc(3,3,6) \quad (3, [x \rightarrow 4, y \rightarrow 3, a \rightarrow 3]) \\
 &= multacc(2,3,9) \quad (3, [x \rightarrow 3, y \rightarrow 3, a \rightarrow 6]) \\
 &= multacc(1,3,12) \quad (3, [x \rightarrow 2, y \rightarrow 3, a \rightarrow 9]) \\
 &= multacc(0,3,15) \quad (3, [x \rightarrow 1, y \rightarrow 3, a \rightarrow 12]) \\
 &= 15 \quad (2, [x \rightarrow 0, y \rightarrow 3, a \rightarrow 15])
 \end{aligned}$$

Uma forma equivalente de descrever o algoritmo *multacc* é através da descrição da mudança dos valores das variáveis, que normalmente é chamada de estado da computação. Neste caso, o estado pode ser representado por uma tripla  $s: \mathbb{N} \times \mathbb{N} \times \mathbb{N} \triangleq \langle x, y, a \rangle$ .

Assim, executando o algoritmo *mult* com os valores 5 e 3 teremos como resultado a seguinte sequência de estados para *multacc* (note que as tuplas de valores que representam os estados da computação estão indicadas entre “ $\langle \quad \rangle$ ” e os sucessivos estados separados por “ $\rightarrow$ ”):
...
| ...                                        | ...                             |
| $s_k = \langle 0, y, \sum_0^k y_k \rangle$ | $\langle x_k, y_k, a_k \rangle$ |

O estado  $s_0$  representa o estado inicial da computação e o estado  $s_k$ , o estado final. Para cada  $j = 0 \dots k$ ,  $s_j = \langle x - j, y, \sum_0^j y_k \rangle$  é o estado após o  $j$ -ésimo passo de computação.

Note que essa sequência de estados é resultado da aplicação das regras na seguinte sequência:

$$(3) \rightarrow (3) \rightarrow (3) \rightarrow (3) \rightarrow (3) \rightarrow (3) \rightarrow (2)$$
...
- $\forall k: \mathbb{N}. x_k \geq 0 \wedge y_k \geq 0$
- $\forall k: \mathbb{N}. x_0 \geq y_k$
- $\forall k: \mathbb{N}. x_k \geq x_{k+1}$
...
|                                                                                                                 |
|-----------------------------------------------------------------------------------------------------------------|
| $\begin{aligned} \text{decNat} &: \mathbb{N} \rightarrow \mathbb{N} \\ \text{decNat}(m) &= m - 1 \end{aligned}$ |
|-----------------------------------------------------------------------------------------------------------------|
...
|                                                                                                                                                             |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
| $\begin{aligned} \text{decNat} &: \mathbb{N} \rightarrow \mathbb{N} \\ \text{decNat}(0) &= 0 \\ \text{decNat}(m) &= m - 1, \text{ se } m > 0 \end{aligned}$ |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
|                                                                                          |
|------------------------------------------------------------------------------------------|
| $decNat: \mathbb{N} \rightarrow \mathbb{N}$<br>$requer: m \geq 1$<br>$decNat(m) = m - 1$ |
|------------------------------------------------------------------------------------------|
...
|                                                                                                                          |
|--------------------------------------------------------------------------------------------------------------------------|
| $decNat: \mathbb{N} \rightarrow \mathbb{N}$<br>$requer: m \geq 1$<br>$garante: decNat(x) = x - 1$<br>$decNat(m) = m - 1$ |
|--------------------------------------------------------------------------------------------------------------------------|
