...
- União A  B = {x / x  A ou x  B} · A={0,1,2} · B={0,2,4,6} · A  B={0,1,2,4,6}
...
```
· A={0,1,2} · B={x,y} · R1={(0,x),(1,x),(2,y)} · R2={(0,x),(0,y),(1,y),(2,y)} · R3={(1,x)}
```
...
- Imagem de R é {y  B |  x  Ae (x,y)  R}

```
· A={0,1,2} · B={x,y} · R3={(1,x)} · dd(R3)={1} · img(R3)={x}
```
...
- A={0,1,2} · B={x,y} · R1={(0,x),(1,x),(2,y)} é função · Escreve-se R1(0)=x ou {0 ⟼ x}  R1 · R2={(0,x),(0,y),(1,y),(2,y)} não é função · R3={(1,x)} é função
...
![Image](C:\Users\Humberto\Desktop\MetodosFormaisClaude\metodos_formais\staging\markdown-auto\docling\revisao\revisao_artifacts\image_000000_ba08c9dda7c707285d42cf54b3bd3634819697895c91b29ef9303d464e0c4999.png)
