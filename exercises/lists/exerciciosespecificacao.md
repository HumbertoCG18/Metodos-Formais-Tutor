...
*buscaBinaria:  $\text{Array}\langle\mathbb{Z}\rangle \times \mathbb{Z} \rightarrow \mathbb{Z}$*
...
*encontrarPrimeiroZero:  $\text{Array}\langle\mathbb{Z}\rangle \rightarrow \mathbb{Z}$*
