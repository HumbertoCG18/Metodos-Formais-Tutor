...
*buscaBinaria:  $Array\langle\mathbb{Z}\rangle \times \mathbb{Z} \rightarrow \mathbb{Z}$*
...
*encontrarPrimeiroZero:  $Array\langle\mathbb{Z}\rangle \rightarrow \mathbb{Z}$*
...
$buscar: Array(\mathbb{Z}) \times \mathbb{Z} \rightarrow \mathbb{B}$
...
$b \leftrightarrow \exists i \in \mathbb{N}. (i < array.tamanho \wedge array[i] = x)$

ou sendo  $|array|$  a notação para o tamanho do array

$b \leftrightarrow \exists i \in \mathbb{N}. (i < |array| \wedge array[i] = x)$

Pós condição (versão 2):

$(b = true \rightarrow \exists i \in \mathbb{Z}. (0 \leq i < |array| \wedge array[i] = x)) \wedge$

$(b = false \rightarrow \forall i \in \mathbb{Z}. (0 \leq i < |array| \rightarrow array[i] \neq x))$
...
$\exists i \in \mathbb{N}. (i < |array| \wedge array[i] = x \wedge \forall j \in \mathbb{N}. (j < |array| \wedge array[j] = x \rightarrow j = i))$
...
Dado  $buscaBinaria(array, x) = r$  temos

$$r < 0 \rightarrow (\forall i \in \mathbb{N}. (i < |array| \rightarrow array[i] \neq x)) \wedge$$
$$r \geq 0 \rightarrow (r < |array| \wedge array[r] = x)$$
...
$$r = -1 \rightarrow (\forall i \in \mathbb{N}. (i < |array| \rightarrow array[i] \neq 0)) \wedge$$
$$r \geq 0 \rightarrow (r < |array| \wedge array[r] = 0 \wedge (\forall i \in \mathbb{N}. (i < r \rightarrow array[i] \neq 0)))$$
