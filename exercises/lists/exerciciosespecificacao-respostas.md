...
```
RESPOSTAS: 1) Seja 𝔹 = {𝑡𝑟𝑢𝑒, 𝑓𝑎𝑙𝑠𝑒} 𝑏𝑢𝑠𝑐𝑎𝑟: 𝐴𝑟𝑟𝑎𝑦〈ℤ〉 × ℤ → 𝔹 Pré condição: 𝑡𝑟𝑢𝑒 Pós condição (versão 1): Dado 𝑏𝑢𝑠𝑐𝑎𝑟(𝑎𝑟𝑟𝑎𝑦, 𝑥) = 𝑏 temos 𝑏 ⟷ ∃𝑖 ∈ ℕ. (𝑖 < 𝑎𝑟𝑟𝑎𝑦. 𝑡𝑎𝑚𝑎𝑛ℎ𝑜 ∧ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑥) ou sendo |𝑎𝑟𝑟𝑎𝑦| a notação para o tamanho do array 𝑏 ⟷ ∃𝑖 ∈ ℕ. (𝑖 < |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑥) Pós condição (versão 2): (𝑏 = 𝑡𝑟𝑢𝑒  ⟶ ∃𝑖 ∈ ℤ. (0 ≤ 𝑖 < |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑥)) ∧ (𝑏 = 𝑓𝑎𝑙𝑠𝑒  ⟶ ∀𝑖 ∈ ℤ. (0 ≤ 𝑖 < |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≠ 𝑥)) 2) a) ∀𝑖 ∈ ℕ. (𝑖 < |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑥) b) ∀𝑖 ∈ ℕ. (𝑖 < |𝑎𝑟𝑟𝑎𝑦| - 1 ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑎𝑟𝑟𝑎𝑦[𝑖 + 1]) c) ∀𝑖 ∈ ℕ. (𝑖 < |𝑎𝑟𝑟𝑎𝑦| - 1 ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≤ 𝑎𝑟𝑟𝑎𝑦[𝑖 + 1]) ou ∀𝑖, 𝑗 ∈ ℕ. (𝑖 < 𝑗 < |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≤ 𝑎𝑟𝑟𝑎𝑦[𝑗]) d) Noçã o 'somente um x tem propriedade P ': ∃𝑥. (𝑃(𝑥) ∧ ∀𝑦. (𝑃(𝑦) ⟶ 𝑦 = 𝑥)) Logo: ∃𝑖 ∈ ℕ. (𝑖 < |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑖] = 𝑥 ∧ ∀𝑗 ∈ ℕ. (𝑗 < |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑗] = 𝑥 ⟶ 𝑗 = 𝑖))
```

3) Pré condição: ∀𝑖, 𝑗 ∈ ℕ. (𝑖 &lt; 𝑗 &lt; |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≤ 𝑎𝑟𝑟𝑎𝑦[𝑗]) Pós condição: Dado 𝑏𝑢𝑠𝑐𝑎𝐵𝑖𝑛𝑎𝑟𝑖𝑎(𝑎𝑟𝑟𝑎𝑦, 𝑥) = 𝑟 temos

𝑟 &lt; 0 ⟶ (∀𝑖 ∈ ℕ. (𝑖 &lt; |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≠ 𝑥)) ∧ 𝑟 ≥ 0 ⟶ (𝑟 &lt; |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑟] = 𝑥) 4) Pré condição: 𝑡𝑟𝑢𝑒 Pós: Dado 𝑒𝑛𝑐𝑜𝑛𝑡𝑟𝑎𝑟𝑃𝑟𝑖𝑚𝑒𝑖𝑟𝑜𝑍𝑒𝑟𝑜(𝑎𝑟𝑟𝑎𝑦) = 𝑟 temos 𝑟 = -1 ⟶ (∀𝑖 ∈ ℕ. (𝑖 &lt; |𝑎𝑟𝑟𝑎𝑦| ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≠ 0)) ∧ 𝑟 ≥ 0 ⟶ (𝑟 &lt; |𝑎𝑟𝑟𝑎𝑦| ∧ 𝑎𝑟𝑟𝑎𝑦[𝑟] = 0 ∧ (∀𝑖 ∈ ℕ. (𝑖 &lt; 𝑟 ⟶ 𝑎𝑟𝑟𝑎𝑦[𝑖] ≠ 0)))
