...
|---|---|---|---|
| Definições de Funções Recursivas Primitivas e Propriedades em Isabelle/HOL | isabelle | recursão primitiva, tipos indutivos, números naturais, listas | `T1_2026_1.thy` |
| Definição de Árvores Binárias e Prova por Indução em Isabelle/HOL | isabelle | árvore binária, tipo de dado indutivo, recursão, função espelho | `arvores.thy` |
| Exemplos de Definição de Tipos Indutivos, Predicados e Funções Recursivas em Isabelle | isabelle | tipos indutivos, predicados indutivos, funções recursivas, definição por recursão primitiva | `exemplos.thy` |
| Definição de Tipos Indutivos, Funções Recursivas e Provas por Indução em Isabelle | Isabelle | Tipo Indutivo, Recursão Primitiva, Prova por Indução, Datatype | `intro.thy` |
| Definição Recursiva de Concatenação de Listas e Prova de Associatividade em Isabelle | isabelle | lista, função recursiva, concatenação de listas, indução estrutural | `listas.thy` |
| Demonstração de propriedades indutivas e funções em Isabelle/HOL | isabelle | Isabelle/HOL, Prova por indução, Definições recursivas, Tipos de dados indutivos | `provas.thy` |
| Definição básica de classe e métodos em Dafny | dafny | Classes, Objetos, Campos, Métodos | `classes_parte1.zip` |
